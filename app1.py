...
model=pickle.load(open('C:/Users/arnav/OneDrive/Desktop/ARNAV/SE/Earthquake_Prediction/model.pkl','rb'))


@app.route('/')
def home():
    return render_template('C:/Users/arnav/OneDrive/Desktop/ARNAV/SE/Earthquake_Prediction/homepage.html')


@app.route('/home')
def home2():
    return render_template('Earthquake_Prediction/homepage.html')
